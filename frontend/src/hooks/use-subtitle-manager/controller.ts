...
export function createSubtitleManagerController({
  ...
  return {
    ...
    setMovieSortBy: workspace.setMovieSortBy,
    toggleMovieSortOrder: workspace.toggleMovieSortOrder,
    setTvSeriesSortBy: workspace.setTvSeriesSortBy,
    toggleTvSeriesSortOrder: workspace.toggleTvSeriesSortOrder,
