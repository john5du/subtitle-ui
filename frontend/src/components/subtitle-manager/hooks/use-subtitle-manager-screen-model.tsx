...
export function useSubtitleManagerScreenModel() {
  ...
  const subtitleActionsModel = useMemo(() => ({
      ...
      refreshVideoAfterMutation: actions.refreshVideoAfterMutation,
      refreshSeriesVideos: actions.refreshSeriesVideos,
      uploading,
      uploadingMessage,
      ...
      actions.refreshSeriesVideos,
      actions.refreshVideoAfterMutation,
