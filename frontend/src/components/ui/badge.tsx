  ...
  "inline-flex items-center border px-2.5 py-0.5 font-mono text-xs uppercase tracking-[0.0625em] transition-colors focus:outline-none focus:ring-2 focus:ring-[rgb(59,130,246)/0.5] focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.03)] text-[rgba(255,255,255,0.7)]",
        destructive: "border-red-500/30 bg-red-500/10 text-red-400",
        outline: "border-[rgba(255,255,255,0.1)] bg-transparent text-[rgba(255,255,255,0.7)]"
      }
    },
    defaultVariants: {
      variant: "default"
